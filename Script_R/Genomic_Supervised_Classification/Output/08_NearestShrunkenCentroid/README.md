# Nearest shrunken-centroid results

The PAM model calculates a centroid for each class and shrinks class-specific centroid differences toward the overall centroid. Classification uses the resulting shrunken class profiles.
...
- `Best_Tuning_Parameters.tabtxt` contains the selected shrinkage threshold.
