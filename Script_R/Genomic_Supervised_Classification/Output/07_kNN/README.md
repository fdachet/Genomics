...
The model assigns classes from the neighboring training samples in the median-imputed, centered, and scaled predictor space.
...
- `Best_Tuning_Parameters.tabtxt` contains the selected number of neighbors (`k`).
