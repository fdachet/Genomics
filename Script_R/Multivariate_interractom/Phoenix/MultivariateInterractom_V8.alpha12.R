...
Result_Correlation_Horyzontal_PerPatient<-data.frame(matrix(NA,1,2+(Variable_Quantity^2-Variable_Quantity)/2))  # patient  WindowSize   AllTheCorsForThisPAtient
Result_Correlation_Horyzontal_PerPatient<-Result_Correlation_Horyzontal_PerPatient[-1,]
Result_Correlation_Horyzontal_PerPatient_CorMax<-Result_Correlation_Horyzontal_PerPatient
...
print("Debug")
Result_Correlation_Horyzontal_PerPatient_CorMax<-rbind(Result_Correlation_Horyzontal_PerPatient_CorMax,c(temp,temp_correlation_1_Max))
Result_Correlation_Horyzontal_PerPatient_CorMax_Location<-rbind(Result_Correlation_Horyzontal_PerPatient_CorMax_Location,c(temptemp_correlation_1_Max_Location))


temp_correlation_2<-rbind(temp_correlation_1_Max_Location)



cbind(Patient_List[indice_patient],indice_CorrelationWindow,temp_correlation_1)
