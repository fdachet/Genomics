...
Result_Correlation_Horyzontal_CorMax_PerPatient<-data.frame(matrix(NA,1,2+(Variable_Quantity^2-Variable_Quantity)/2))  # patient  WindowSize   AllTheCorsForThisPAtient
Result_Correlation_Horyzontal_CorMax_PerPatient<-Result_Correlation_Horyzontal_CorMax_PerPatient[-1,]
Result_Correlation_Horyzontal_CorMax_Location_PerPatient<-Result_Correlation_Horyzontal_CorMax_PerPatient
Result_Correlation_Horyzontal_CorMax_PerPatient_PerWindows<-Result_Correlation_Horyzontal_CorMax_PerPatient
Result_Correlation_Horyzontal_CorMax_Location_PerPatient_PerWindows<-Result_Correlation_Horyzontal_CorMax_PerPatient
...
Result_Correlation_Horyzontal_CorMax_PerPatient_PerWindows<-Result_Correlation_Horyzontal_CorMax_Location_PerPatient_PerWindows[1,]
Result_Correlation_Horyzontal_CorMax_PerPatient_PerWindows<-Result_Correlation_Horyzontal_CorMax_Location_PerPatient_PerWindows[-1,]
...
colnames(Result_Correlation_Horyzontal_CorMax_PerPatient_PerWindows) <- c("Patient","CorrelationWindowLength",names_mat[lower.tri(names_mat)] ) # put the names
colnames(Result_Correlation_Horyzontal_CorMax_Location_PerPatient_PerWindows) <- c("Patient","CorrelationWindowLength",names_mat[lower.tri(names_mat)] ) # put the names
