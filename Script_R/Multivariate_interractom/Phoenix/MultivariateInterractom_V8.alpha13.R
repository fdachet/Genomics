...
print("Debug")
Result_Correlation_Horyzontal_CorMax_PerPatient<-rbind(Result_Correlation_Horyzontal_CorMax,c(temp,temp_correlation_1_Max))
Result_Correlation_Horyzontal_CorMax_Location_PerPatient<-rbind(Result_Correlation_Horyzontal_CorMax_Location,c(temp,temp_correlation_1_Max_Location))
...
apply(Result_Correlation_Horyzontal_CorMax_PerPatient,2,function(X){which.max(abs(X))})
