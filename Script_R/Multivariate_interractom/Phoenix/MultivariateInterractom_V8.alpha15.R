...
#Input_A<-cbind(Input_A[,1],Input_A)
      #endregion#
...
#Result_Correlation_Horyzontal_CorMax<-data.frame(matrix(NA,1,2+(Variable_Quantity^2-Variable_Quantity)/2))  # patient  WindowSize   AllTheCorsForThisPAtient
#Result_Correlation_Horyzontal_CorMax<-Result_Correlation_Horyzontal_CorMax[-1,]
#Result_Correlation_Horyzontal_CorMax_Location<-Result_Correlation_Horyzontal_CorMax
Result_Correlation_Horyzontal_CorMax_PerPatient<-Result_Correlation_Horyzontal_CorMax
Result_Correlation_Horyzontal_CorMax_Location_PerPatient<-Result_Correlation_Horyzontal_CorMax
...
Result_Correlation_Horyzontal_CorMax_PerPatient<-rbind(Result_Correlation_Horyzontal_CorMax_PerPatient,c(temp,temp_correlation_1_Max))
Result_Correlation_Horyzontal_CorMax_Location_PerPatient<-rbind(Result_Correlation_Horyzontal_CorMax_Location_PerPatient,c(temp,temp_correlation_1_Max_Location))
...
#ne garder que le max
Result_Correlation_Horyzontal_CorMax_PerPatient[,2:ncol(Result_Correlation_Horyzontal_CorMax_PerPatient)]<-apply(Result_Correlation_Horyzontal_CorMax_PerPatient,2,as.numeric)
apply(Result_Correlation_Horyzontal_CorMax_PerPatient[,2:ncol(Result_Correlation_Horyzontal_CorMax_PerPatient)],2,function(X){which.max(abs(X))})
